...
OKCoin.prototype.getFutureTicker = function getFutureTicker(callback, symbol, contract_type) 
{
    this.publicRequest('future_ticker', {
        symbol: symbol,
...
OKCoin.prototype.getFutureDepth = function getFutureDepth(callback, symbol, contract_type, size, merge)
{
    var params = {};
...
OKCoin.prototype.getFutureIndex = function getFutureIndex(callback, symbol) 
{
    var params = {};
    if(symbol) params.symbol = symbol;
...
OKCoin.prototype.getExchangeRate = function getExchangeRate(callback)
{
    var params = {};
    
    this.publicRequest('exchange_rate', params, callback);
};

OKCoin.prototype.getFutureEstimatedPrice = function getFutureEstimatedPrice(callback, symbol) 
{
    var params = {};
    if(symbol) params.symbol = symbol;
    
    this.publicRequest('future_estimated_price', params, callback);
};
...
OKCoin.prototype.getFutureTrades = function getFutureTrades(callback, symbol, contract_type)
{
    var params = {symbol: symbol};
    if (contract_type) params.contract_type = contract_type;
...
OKCoin.prototype.getFutureKline = function getFutureKline(callback, symbol, type, contract_type, size, since) {
    var params = {symbol: symbol};
    if(type) params.type = type;
    if(contract_type) params.contract_type = contract_type;
    if(size) params.size = size;
...
{
    this.publicRequest('lend_depth', {symbol: symbol}, callback);
};

OKCoin.prototype.getFutureHoldAmount = function getFutureHoldAmount(callback, symbol, contract_type) 
{
    var params = {};
    if(symbol) params.symbol = symbol;
    if(contract_type) params.contract_type = contract_type;
    
    this.publicRequest('future_hold_amount', params, callback);
};
...
OKCoin.prototype.getFutureUserInfo = function getFutureUserInfo(callback)
{
...
OKCoin.prototype.addFutureTrade = function addFutureTrade(callback, symbol, contract_type, amount, price, ordertype, match_price, lever_rate)
{
    var params = {
        symbol: symbol,
        type: ordertype
...
OKCoin.prototype.cancelFutureOrder = function cancelFutureOrder(callback, symbol, contract_type, order_id)
{
...
OKCoin.prototype.getFutureOrderInfo = function getFutureOrderInfo(callback, symbol, contract_type, status, order_id, current_page, page_length)
{
...
OKCoin.prototype.getFutureOrdersInfo = function getFutureOrdersInfo(callback, symbol, contract_type, order_id)
{
...
OKCoin.prototype.getFuturePositions = function getFuturePositions(callback, symbol, contract_type) 
{
...
OKCoin.prototype.getFixedFuturePositions = function getFixedFuturePositions(callback, symbol, contract_type, type)
{
    var params = {};
    ...
    this.privateRequest('future_position_4fix', params, callback);
};

OKCoin.prototype.getFixedUserInfo = function getFixedUserInfo(callback) 
{
