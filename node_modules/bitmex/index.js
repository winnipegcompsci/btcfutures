...
var BitMEX = function BitMEX(api_key, secret, server, timeout)
{
    ...
    this.server = server || 'https://www.bitmex.com:443';
...
BitMEX.prototype.privateRequest = function(method, params, callback)
{
    var functionName = 'BitMEX.privateRequest()',
        self = this;
 ...
 */
BitMEX.prototype.signMessage = function getMessageSignature(params)
{
