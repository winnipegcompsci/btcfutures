...
BitVC.prototype.privateRequest = function(method, params, callback)
{
    ...
    params.created = Math.ceil(new Date().getTime() / 1000);
...
BitVC.prototype.signMessage = function getMessageSignature(params)
{
    ...
    var sign = md5(formattedParams).toUpperCase();
    
    console.log("BitVC Formatted Params: " + formattedParams);
    console.log("BitVC SIGN Result: " + sign);
...
BitVC.prototype.getThisWeekFutureTicker = function getThisWeekFutureTicker(callback) 
{
    this.publicRequest(
...
BitVC.prototype.getNextWeekFutureTicker = function getNextWeekFutureTicker(callback)
{
    this.publicRequest(
        'http://market.bitvc.com/futures/ticker_btc_next_week.js',
        {},
        callback
    );
};

BitVC.prototype.getQuarterFutureTicker = function getQuarterFutureTicker(callback)
{
    this.publicRequest(
        'http://market.bitvc.com/futures/ticker_btc_quarter.js',
        {},
...
BitVC.prototype.getDepth = function getDepth(callback, symbol, size, merge)
{
    ...
    this.publicRequest('http://market.bitvc.com/futures/depths_btc_quarter.js', params, callback);
};
...
BitVC.prototype.getTrades = function getTrades(callback, symbol, since)
{
    ...
    this.publicRequest('http://market.bitvc.com/futures/trades_btc_quarter.js', params, callback);
};
...
{
    this.privateRequest('https://api.bitvc.com/futures/balance', {}, callback); 
};

BitVC.prototype.getUserPositions = function getUserPositions(callback, coinType)
{
    var params = {};
    if(coinType) params.coinType = coinType;
    if(!coinType) params.coinType = 1;
    
    this.privateRequest('https://api.bitvc.com/futures/holdOrder/list', params, callback);
};

BitVC.prototype.getUserPositionSummary = function  getUserPositionSummary(callback)
{
    this.privateRequest('https://api.bitvc.com/futures/holdOrder', {}, callback);
};

BitVC.prototype.getAllCurrentOrders = function getAllCurrentOrders(callback)
{
    this.privateRequest('https://api.bitvc.com/futures/order/list', {}, callback);
};
...
BitVC.prototype.getOrderDetails = function getOrderDetails(callback, coinType, contractType, created, id) {
    ...
    this.privateRequest('https://api.bitvc.com/futures/order', params, callback);
};
...
BitVC.prototype.placeOrder = function placeOrder(callback, coinType, contractType, created, orderType, tradeType, price, money, leverage, tradePassword, storeId)
{
    ...
    this.privateRequest('https://api.bitvc.com/futures/order/save', params, callback);
...
BitVC.prototype.cancelOrder = function cancelOrder(callback, coinType, contractType, created, id) 
{
    ...
    this.privateRequest('https://api.bitvc.com/futures/order/cancel', params, callback);
};
...
BitVC.prototype.systemCloseOrder = function systemCloseOrder(callback, coinType, contractType, created)
{
    ...
    this.privateRequest('https://api.bitvc.com/futures/systemCloseOrder/list', params, callback);
}
