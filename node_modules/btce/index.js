...
var headers = {
        "User-Agent": "BTCe Javascript API Client"
};   
...
BTCe.prototype.privateRequest = function(method, params, callback)
{
    ...
    params.nonce = Math.ceil(new Date().getTime() / 1000);
    // params.apikey = this.api_key;
   
    headers = {
        "Key": this.api_key,
        "Sign": this.signMessage(params, this.secret),
        "User-Agent": "BTC-e Javascript API Client",
...
/**
 * This method returns a signature for a request as sha512-hmac encrypted with secretkey.
 * @param  {Object}  params   The object to encode
 * @return {String}           The request signature
 */
BTCe.prototype.signMessage = function getMessageSignature(params, secret)
{
...
{
    // This method is different from other formatParameters on other exchanges!
    var str = [];
    for(var p in params) {
